...
public class MCP3008OutputConverterTest {
    ...
    public void test_anemometer_value_conversion_min(){
        MCP3008OutputConverter adafruitAnemometerConverter = new MCP3008OutputConverter(AdafruitAnemometer.SENSOR_VOLTAGE_MIN, AdafruitAnemometer.SENSOR_VOLTAGE_MAX, AdafruitAnemometer.MAX_WIND_SPEED_MPS);
